      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 w-64 h-64 bg-orange-200 rounded-full opacity-50 z-0"></div>
            <div className="absolute -top-6 -left-6 w-48 h-48 bg-orange-300 rounded-full opacity-30 z-0"></div>
          </div>
        </div>
      </div>
