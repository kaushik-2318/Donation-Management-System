...
export default function DonationRequests() {
  const requests = [
    ...
    },
    {
      ...
      description: "I'm the first in my family to attend college and need help with tuition.",
      image: "/placeholder.svg?height=200&width=300",
      raised: 48000,
      goal: 100000,
      daysLeft: 45,
  ...
  return (
    <section className="mb-16">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link href="/requests" className="text-orange-600 hover:underline group flex items-center">
          View All
        ...
        {requests.map((request) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="text-sm text-gray-600 mb-2">Requested by: {request.requester}</div>
              ...
              <div className="flex justify-between text-sm mb-4">
                <span className="font-medium">₹{request.raised.toLocaleString()}</span>
                <span className="text-gray-500">₹{request.goal.toLocaleString()}</span>
              </div>
